...
function getdt() {
    ...
    var url = "search_medical_print4_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        opener.document.getElementById('vdrlchest_txt').value=obj.vdrlchest;
        opener.document.getElementById('xray_txt').value=obj.xray;
        opener.document.getElementById('vacci_txt').value=obj.vaccination;
