...
function getdt() {
    ...
    var url = "search_item_master_file_data.php";
...
function passcusresult_quot()
{
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete")
    {
        ...
        if (stname === "Master") {
            ...
            opener.document.getElementById('item_ref').value = XMLAddress1[0].childNodes[0].nodeValue;

            XMLAddress1 = xmlHttp.responseXML.getElementsByTagName("item_name");
            opener.document.getElementById('item_name').value = XMLAddress1[0].childNodes[0].nodeValue;
        }
