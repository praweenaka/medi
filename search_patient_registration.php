...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" href="css/bootstrap.min.css">
            ...
            <script language="JavaScript" src="js/search_patient_registration.js"></script>
    ...
    <body>
        ...
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                foreach ($conn->query($sql) as $row) {
                    $cuscode = $row['refno'];
                    echo "<tr>                
                              <td onclick=\"custno('$cuscode');\">" . $row['refno'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['medcode'] . "</a></td>
                              <td onclick=\"custno('$cuscode');\">" . $row['AGNAME'] . "</a></td>
                             </tr>";
                }
                ?>
            </table>
