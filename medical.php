					...
					<div class="col-sm-6">
                        ...
                        <div class="col-md-1">
                            <a href="home.php?url=Customer"  target="_blank">
                                <input type="button" name="searchitem" id="searchitem" value="ADD NEW PATIENT" class="btn btn-primary btn-sm">
                            </a>
                        </div>
                 ...
                 <div class="col-md-9">
                    <select name="name" id="name" class="selectpicker form-control select2"  onchange="histroy();" data-show-subtext="true" data-live-search="true" style="width: 100%">
                       ...
                       foreach ($conn->query($sql) as $row) {
                          echo "<option value='" . $row["code"] . "'>" . $row["code"] . "-" . $row["name"] . "-" . $row["tel"] . "</option>";
                      }
                      ?>
                  </select>
              </div> 
...
<div class="container col-md-9">
  <ul class="nav nav-tabs">
     <li class="active"><a data-toggle="tab" href="#report7" style="color:red;">EXAMINATION</a></li>
