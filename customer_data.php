...
//    uniq
    ...
    $no = trim("CUS/") . substr($tmpinvno, $lenth - 7);
...
if ($_GET["Command"] == "save_item") {
    ...
    try {
        ...
        $sql1 = "select * from customer where custcode = '" . $_GET['cust_txt'] . "'";
        ...
        $sql1 = "Insert into customer(custcode,uniq,name,address1,address2,contact,opening_bal,opening_dt,current_bal,credit_lmt,telno,fax,labourno)values
                      ('" . $_GET['cust_txt'] . "','" . $_GET['uniq'] . "','" . $_GET['name_txt'] . "','" . $_GET['addr1_txt'] . "','" . $_GET['addr2_txt'] . "','" . $_GET['contact_txt'] . "','" . $_GET['openbal_txt'] . "','" . $_GET['opdate_txt'] . "','" . $_GET['currbal_txt'] . "','" . $_GET['crlimit_txt'] . "','" . $_GET['telno_txt'] . "','" . $_GET['fax_txt'] . "','" . $_GET['labourno_txt'] . "')";
        ...
        $no = $row['ctmcode'];
        $no2 = $no + 1;
        $sql = "update invpara set ctmcode = $no2 where ctmcode = $no";
        $result = $conn->query($sql);
