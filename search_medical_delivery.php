...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="JavaScript" src="js/search_medical_delivery.js"></script>
    ...
    <body>
        ...
        <table width="735"   class="table table-bordered">
            ...
            <tr>
                ...
                <td width="24" ><input type="text" size="70" name="customername3" id="customername3" value=""  class="form-control" onkeyup="<?php echo "update_cust_list('$stname')"; ?>"/></td>
        </table>    
        <div id="filt_table" class="CSSTableGenerator">  <table width="735"   class="table table-bordered">
                ...
                <?php
                 ...
                 $sql = "SELECT * from med_dele  where cancel='0'";
